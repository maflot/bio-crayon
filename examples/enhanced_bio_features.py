...
def demonstrate_colorblind_safety():
    ...
    test_data = {
        ...
        "colormaps": {
            "unsafe_categorical": {
                ...
                "colors": {"low": "#FF0000", "medium": "#00FF00", "high": "#0000FF"},
            },
            "safe_categorical": {
                "type": "categorical",
                "description": "Colorblind-safe colors",
                "colors": {"low": "#000000", "medium": "#E69F00", "high": "#56B4E9"},
            },
        },
    }
    ...
    titles = [
        "Unsafe (Red-Green-Blue)",
        "Safe (Black-Orange-Blue)",
        "Auto-Generated Safe",
    ]
...
def demonstrate_expression_validation():
    ...
    for colormap, min_val, max_val, description in test_cases:
        ...
        print(
            f"{colormap:15} | {min_val:5.1f}-{max_val:5.1f} | {status:6} | {error_msg}"
        )
