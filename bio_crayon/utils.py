...
def is_colorblind_safe(colors: List[str], colorblind_type: str = "deuteranopia") -> bool:
    """
...
def get_colorblind_safe_colors(n_colors: int, colorblind_type: str = "deuteranopia") -> List[str]:
    """
