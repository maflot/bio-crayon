...
from bio_crayon.validators import (
    validate_colormap_data, validate_hex_color, validate_colormap_name,
    validate_continuous_colormap, validate_categorical_colormap,
    validate_metadata, validate_metadata_required
)
...
class TestColormapNameValidation:
    ...
    def test_valid_names(self):
        ...
        valid_names = [
            "test", "test123", "test_name", "TestName",
            "_test", "test_", "_test_", "name123"
        ]
...
class TestCategoricalColormapValidation:
    ...
    def test_invalid_category_name(self):
        ...
        colormap = {
            ...
            "colors": {
                "category1": "#FF0000",
                123: "#00FF00"  # Invalid category name
            }
        }
